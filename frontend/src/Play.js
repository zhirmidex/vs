    ...
    <div class="grid-container"> 
        <side2>
            ...
            <ul class="convo">
                ...
                <i class="fa-solid fa-circle" style={ {position:' absolute', marginTop: '17px', marginRight: '23px', fontSize: '9px',color: '#0B9268'}}></i> <li>register for an Onli Cloud api key</li> 



                <i class="fa-solid fa-circle" style={{position: 'absolute',marginTop: '17px',marginRight: '23px', fontSize: '9px', color: '#666666'}}></i> <li>create master users <br></br>
</li>  
                <i class="fa-solid fa-circle" style={{position: 'absolute',marginTop: '17px',marginRight: '23px', fontSize: '9px', color: '#666666'}}></i><li>approve  demo users</li>  


                <i class="fa-solid fa-circle" style={{position: 'absolute',marginTop: '17px',marginRight: '23px', fontSize: '9px', color: '#666666'}}></i><li>mint assets</li>  
                <i class="fa-solid fa-circle" style={{position: 'absolute',marginTop: '17px',marginRight: '23px', fontSize: '9px', color: '#666666'}}></i> <li>stock treasury</li>  
                <i class="fa-solid fa-circle" style={{position: 'absolute',marginTop: '17px',marginRight: '23px', fontSize: '9px', color: '#666666'}}></i> <li>download appliance</li>  
                <i class="fa-solid fa-circle" style={{position: 'absolute',marginTop: '17px',marginRight: '23px', fontSize: '9px', color: '#666666'}}></i> <li>log in as demo user<br></br> of onli</li>  
                <i class="fa-solid fa-circle" style={{position: 'absolute',marginTop: '17px',marginRight: '23px', fontSize: '9px', color: '#666666'}}></i><li>Transfer Assets</li>  
                <i class="fa-solid fa-circle" style={{position: 'absolute',marginTop: '17px',marginRight: '23px', fontSize: '9px', color: '#666666'}}></i> <li>review code to see how it was done</li>  
            </ul>
    ...
    <side1>
     ...
     <div class="beginbody">
        <div class="heading2">
          ...
          <div class="heading2">
            <a href="/play"  > <p style={{color:'white'}}>
                PLAY
            </p></a>
            <h1>
