    ...
    <div class="grid-container"> 
        <side2>
            ...
            <ul class="convo">
                ...
                <i class="fa-solid fa-circle" style={ {position:' absolute', marginTop: '17px', marginRight: '23px', fontSize: '9px',color: '#0B9268'}}></i> <li>what is Onli</li> 



                <i class="fa-solid fa-circle" style={{position: 'absolute',marginTop: '17px',marginRight: '23px', fontSize: '9px', color: '#666666'}}></i> <li>how is Onli different from <br></br>
</li>  
                <i class="fa-solid fa-circle" style={{position: 'absolute',marginTop: '17px',marginRight: '23px', fontSize: '9px', color: '#666666'}}></i><li>how does Onli work</li>  


                <i class="fa-solid fa-circle" style={{position: 'absolute',marginTop: '17px',marginRight: '23px', fontSize: '9px', color: '#666666'}}></i><li>where do I buy onli</li>  
                <i class="fa-solid fa-circle" style={{position: 'absolute',marginTop: '17px',marginRight: '23px', fontSize: '9px', color: '#666666'}}></i> <li>what is onli one network</li>  
                <i class="fa-solid fa-circle" style={{position: 'absolute',marginTop: '17px',marginRight: '23px', fontSize: '9px', color: '#666666'}}></i> <li>what is onli cloud</li>  
                <i class="fa-solid fa-circle" style={{position: 'absolute',marginTop: '17px',marginRight: '23px', fontSize: '9px', color: '#666666'}}></i> <li>what are the core concepts<br></br> of onli</li>  
                <i class="fa-solid fa-circle" style={{position: 'absolute',marginTop: '17px',marginRight: '23px', fontSize: '9px', color: '#666666'}}></i><li>how do I get started</li>  
                <i class="fa-solid fa-circle" style={{position: 'absolute',marginTop: '17px',marginRight: '23px', fontSize: '9px', color: '#666666'}}></i> <li>what does the Onli<br></br> Corporation make</li>  
            </ul>
